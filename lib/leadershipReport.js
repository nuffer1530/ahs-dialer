...
export async function gatherWeeklyFacts({ stGet, stPageAll, supabase, tenantId, weekEnd }) {
  ...
  // Complimentary memberships are giveaways, not sales — leadership counts
  // clubs SOLD, so drop any membership whose type name says complimentary
  // (per Brandyn, Aug 2026).
  try {
