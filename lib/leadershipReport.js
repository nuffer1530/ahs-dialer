        ...
        tools: [{
          ...
          input_schema: {
            ...
            properties: {
              ...
              actionsByDept: {
                type: 'array',
                description: 'Action items grouped by department. Only include departments that need action this week. Use dept names: HVAC, Plumbing, Electrical, Garage Doors, Call Center, Company.',
                items: {
                  type: 'object',
                  properties: {
                    dept: { type: 'string' },
