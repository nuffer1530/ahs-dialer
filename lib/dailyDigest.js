...
function fieldProHtml(fp, ai) {
  ...
  return `
    ...
    <div style="font-size:11px;color:${C.mute};margin-top:8px">Field Pro (Siro) records the tech's conversation in the home and scores it 0–100 on the trade's scorecard (80+ strong, 50–79 developing, under 50 a gap). Re-Engage leads are emailed to the tech, their operations manager and Brandyn as they come in. Full coaching cards: Andi → Team → Technicians.</div>`
}
